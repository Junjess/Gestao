...
namespace Gestao
{
    internal class Program
    {
        ...
        {
            string nomeEquipamento = "", precoEquipamento = "", nSerieEquipamento = "", dataEquipamento = "", fabricanteEquipamento = "";
            string tituloChamada = "", descricaoChamada = "", nEquipamentoChamada = "", dataAberturaChamada = "";
            Boolean achouEquipamento = false, achouEquipamentoExcluir = false, achouEquipamentoChamado = false, achouEquipamentoExcluirChamado = false;
                ...
                while (respostaGeral != 3)
                {
                    if (respostaGeral == 1)
                    {
                        ...
                        while (respostaEquipamento != 5)
                        {
                            ...
                            {
                                case 1:
                                    informacoesEquipamento(nomeEquipamento, precoEquipamento, nSerieEquipamento, dataEquipamento, fabricanteEquipamento);
                                    Console.WriteLine();
                    ...
                    if (respostaGeral == 2)
                    {
                        ...
                        while (respostaChamada != 5)
                        {
                            ...
                            {
                                case 1:
                                    informacoesChamado(tituloChamada, descricaoChamada, nEquipamentoChamada, dataAberturaChamada);
                                    Console.WriteLine();
            ...
            static void informacoesEquipamento(string nomeEquipamento, string precoEquipamento, string nSerieEquipamento, string dataEquipamento, string fabricanteEquipamento)
            {
            ...
            static void informacoesChamado(string tituloChamada, string descricaoChamada, string nEquipamentoChamada, string dataAberturaChamada)
            {
